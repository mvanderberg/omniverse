		...
		while not self.CANCEL:
			try:
				...
				try:
					...
					logging.getLogger().exception("General failure while processing message. Subject: %s, From: %s, Message ID: %s, Date: %s, Lines: %s, Group: %g" % (subject, _from, message_id, date, lines, group))
